...
>(({ className, ...props }, ref) => (
	<MenubarPrimitive.Root
		ref={ref}
		className={cn('flex h-8 items-center space-x-1 rounded-md border border-slate-300 bg-white p-1 ', className)}
		{...props}
	/>
));
...
>(({ className, ...props }, ref) => (
	<MenubarPrimitive.Trigger
		ref={ref}
		className={cn(
			'flex cursor-default select-none items-center rounded-[0.2rem] py-1 px-3 text-sm font-medium outline-none focus:bg-slate-100 data-[state=open]:bg-slate-100',
			className,
		)}
		{...props}
	/>
