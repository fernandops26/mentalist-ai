...
const features = [
  {
    imgSrc:
      'https://tailus.io/sources/blocks/stacked/preview/images/avatars/burger.png',
    icon: 'idea',
    imgAlt: 'burger illustration',
    title: 'Generate content ideas',
    description:
      'Easily generate ideas for content related to any social media topic',
  },
  {
    imgSrc:
      'https://tailus.io/sources/blocks/stacked/preview/images/avatars/trowel.png',
  ...
  {
    imgSrc:
      'https://tailus.io/sources/blocks/stacked/preview/images/avatars/package-delivery.png',
  ...
  {
    imgSrc:
      'https://tailus.io/sources/blocks/stacked/preview/images/avatars/metal.png',
    ...
    <div className='relative group bg-slate-50 hover:bg-white transition hover:z-[1] hover:shadow-2xl'>
      <div className='relative p-8 space-y-8'>
        ...
        <div className='space-y-2'>
          <h5 className='text-xl text-gray-800 font-medium transition group-hover:text-purple-600'>
            {title}
          </h5>
